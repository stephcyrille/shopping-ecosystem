...
from myproxy.serializers.profile_serializer import AddressUpdateSerializer, ProfileUpdateSerializer
...
class UpdateAddressViews(APIView):
    permission_classes = [IsAuthenticated]
